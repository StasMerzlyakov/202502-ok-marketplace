...
"Снабженец" -- специализированная на индустриальных компонентах и комплектующих площадка, на которой пользователи могут 
...
![Визуальная схема фронтенда](./img/marketplace.png)

https://www.figma.com/design/E1UH3sInqlHFuY9bkVDJWV/marketplace?node-id=1-6&p=f
